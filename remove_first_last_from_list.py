...
def remove_first_and_last(list_toclean): # say function remove first and last and list to clean is passed in
    , *content, _ = list_toclean      # GLOB(ability to grab the elements, * returns the list in the middle)  will ignore the element
