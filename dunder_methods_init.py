# double underscores-private and protected methods in classesinit
...
class Invoice:                                # invoice class
    def str(self):                        # dunder string- pass in self(str method to help you get visabilty what you instatiated)
      return "This is the invoice class!"
# python looks for str and looks for what is returned
# debugging purposes str
...
class Invoice:
  def init(self, client, total):          # dunder init takes in self and client and total
    self.client = client
    self.total = total

  def str(self):                                        # using string interpolation below
