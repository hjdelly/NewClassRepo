...
def title_generator(links):       # function that takes in links
    ...
    def post_formatter(url):            # function in the generator-but passed in url
...
r = requests.get('http://www.dailysmarty.com/topics/python%27') # pull in the site by using the requests.get 
