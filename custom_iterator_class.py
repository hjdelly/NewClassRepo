class Lineup:
    ...
    def init(self, players):                              # init method pass in self and players
        self.players = players                                # self.players and set equal to players
        self.last_player_index = (len(self.players) - 1)      # instance variable(last player index) stored length of the players list

    def iter(self):                                       # function dunder iter and passed in self
    ...
    def next(self):                                       # dunder next to call next on the item
