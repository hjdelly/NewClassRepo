...
tiffany = AdminUser('tiffany@devcamp.com', 'Tiffany', 'Hudgens') # instance tiffany is an admin user, she has an email and first name and last name
 
kristine = User('kristine@devcamp.com', 'Kristine', 'Hudgens')   # and created instance a regular user here names kristine and the same attributes as above
...
print(kristine.active_users()) # if you try to have kristine access (returns no active users error)

# inheritance is the ability to create specialized versions of classes