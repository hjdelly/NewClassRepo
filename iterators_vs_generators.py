class InfiniteLineup:                        # class infinite lineup 
    def init(self, players):             # create the init method here and self and players passed in
    ...
    def repr(self):                      # dudner repr takes in self and returns the entire object(string)
        return f'InfiniteLineup({self.players})'

    def str(self):                       # dunder string method takes in self
