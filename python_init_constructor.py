class Invoice:                           # behavior in class is with functions---data in classes below
    def init(self, client, total):   # custructor function- function def dunder init -auto called whenever you call the class-add data in class(first argument self, then client and total)
