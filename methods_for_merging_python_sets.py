...
# tags in tags_one but not in tags_two ###Venn-diagram example 
exclusive_to_tag_one = tags_one - tags_two  # just say tags one minus tags two returns only python
print(exclusive_to_tag_one) # you are looking for what tags belong only in tags 1(example a Venn-diagram)-and ignores ruby and development
